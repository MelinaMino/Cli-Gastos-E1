...
exports.readGastosFile = exports.writeGastosFile = exports.DATABASE_GASTOS = void 0;
const promises_1 = require("fs/promises");
exports.DATABASE_GASTOS = 'gastos.json';
const writeGastosFile = (data) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, promises_1.writeFile)(exports.DATABASE_GASTOS, JSON.stringify(data));
    return null;
});
exports.writeGastosFile = writeGastosFile;
const readGastosFile = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const expenses = (yield (0, promises_1.readFile)(exports.DATABASE_GASTOS)).toString();
        return expenses;
    }
    catch (error) {
